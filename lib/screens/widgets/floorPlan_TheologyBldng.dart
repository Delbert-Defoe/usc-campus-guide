...
void main() {
  runApp(floorPlan_TheologyBldng());
}

class floorPlan_TheologyBldng extends StatelessWidget {
  @override
            ...
            child: GestureDetector(
              ...
              child: Transform(
                transform: Matrix4.identity()
                  ...
                  ..scale(_scale),
                child: CustomPaint(
                  size: Size(cpWidth, (cpWidth * 0.743).toDouble()),
